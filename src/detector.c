...
void run_detector(int argc, char **argv)
{
    ...
    else if (0 == strcmp(argv[2], "test_classification")) test_detector_classification(datacfg, cfg, weights, filename, thresh, hier_thresh, dont_show, ext_output, save_labels, outfile);
